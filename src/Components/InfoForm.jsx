...
export const InfoForm = () => {
  ...
  const validationSchema = yupObject().shape({
    ...
    SisterProfession: yupString()
      ...
      .max(20, "Too Long")
      .required("*Profession Is Required"),
    SisterSalery: yupString()
      .min(3, "Too Short")
      .min(20, "Too Long")
      .required("*Salery Is Required"),
    email: yupString()
          ...
          <Form.Row>
            <Form.Group as={Col} controlId="SisterName">
              ...
              <Form.Control
                ...
                value={formik.values.SisterName}
                maxLength={21}
                onChange={(e) =>
            ...
            <Form.Group as={Col} controlId="SisterEducation">
              <Form.Label>Education</Form.Label>
              <Form.Control
                type="text"
                placeholder="Enter Education"
                ...
                maxLength={21}
                onChange={(e) =>
                  formik.setFieldValue("SisterEducation", e.target.value)
                }
                onBlur={formik.handleBlur}
                isInvalid={
            ...
            <Form.Group as={Col} controlId="SisterProfession">
              <Form.Label>Profession</Form.Label>
              <Form.Control
                type="text"
                placeholder="Enter Profession"
